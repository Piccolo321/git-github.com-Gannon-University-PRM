   ...
   : CDialog(CPGRStereoControlDialog::IDD, pParent)
{
   ...
   //Dipti Killedar
   // base line changed to 1.016 (40 inches) from 1
   base_line = 1.016;
   //Keep smsurface smaller for better grid, 
   //if you increase smsurface grid will become smoother
   smsurface = 0.00600;   
}

void CPGRStereoControlDialog::DoDataExchange( CDataExchange* pDX )
{
   int	    sliderValue;
