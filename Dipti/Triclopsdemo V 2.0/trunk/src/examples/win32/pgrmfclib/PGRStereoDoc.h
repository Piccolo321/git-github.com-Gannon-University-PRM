...
public:
   ...
   //Set ROI 
   void setROI(CPoint P1,CPoint P2);
   /** Set Center of ROI Pixel X Y/Row col */
   void setCenterPixelXY(double CenterX,double CenterY);
   ...
   //Yixin Geng
   /**  ROI start and end point */
   CPoint start;
   CPoint end;

   /** Center of Region Pixel X Y */
   double CenterPixX;
   double CenterPixY;
...
protected:
   ...
   //Yixin Geng
   void OnFileExportHighResolution(float baseline,float smsurface);
