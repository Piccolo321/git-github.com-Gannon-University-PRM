...
public:
   ...
   CPGRStereoDoc* GetDocument();
	...
	int flag;
    enum flagPositions {topLeft, topRight, bottomRight, bottomLeft};
...
protected:
   ...
   /**
    * Overridable method for doing extra draw steps for each frame.  Ie, lines, text.
    */
   virtual void	  customDraw( CDC* pDC );

   /**
    * Resizes this window based on the requested resolution, ie 320 pixels by 240 pixels.
    */
