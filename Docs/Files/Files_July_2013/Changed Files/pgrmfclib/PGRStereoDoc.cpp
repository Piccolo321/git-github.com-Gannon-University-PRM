...
CPGRStereoDoc::doStereo()
{
   ...
   //te = triclopsGetROIs( m_triclopsContext, &pRois, &nMaxRois );
   ...
   //   pRois[0].row   = 0;
   //   pRois[0].col   = 75;
   //   pRois[0].nrows = end.x - start.x;
   //   pRois[0].ncols = end.y - start.y;

	  //// Part of the lower right
	  //pRois[1].row   = end.x - start.x;
   //   pRois[1].col   = 75;
   //   pRois[1].nrows = end.x - start.x;
   //   pRois[1].ncols = end.y - start.y;
   //  
   //   // Centered in upper right quadrant
   //   pRois[2].row   = 0;
   //   pRois[2].col   = end.y - start.y;
   //   pRois[2].nrows = end.x - start.x;
   //   pRois[2].ncols = end.y - start.y;
   //  
   //   // Small section of lower left
   //   pRois[3].row   = end.x - start.x;
   //   pRois[3].col   = end.y - start.y;
   //   pRois[3].nrows = end.x - start.x;
   //   pRois[3].ncols = end.y - start.y;
	  //    
   //   // Tell the TriclopsContext how many ROIs we want to process	
	  //te = triclopsSetNumberOfROIs( m_triclopsContext, 4 );
...
{	
    ...
    /*
     * Converting ROI start pixel points to real points ;
     */
